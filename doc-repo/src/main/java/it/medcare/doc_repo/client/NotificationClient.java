package it.medcare.doc_repo.client;
...
public class NotificationClient {
    ...
    public void notifyReportUploaded(NotificationReportRequest request) {
        ...
        try {
            ...
            String url = notificationBaseUrl + "/reports/uploaded";
            RequestEntity<NotificationReportRequest> req = RequestEntity
                .post(URI.create(url))
